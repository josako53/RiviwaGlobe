...
from models.subscription import AddOn, OrgFeatureOverride, Plan, PromoCode, Sale
...
_STARTER_FEATURES = dict(
    # Feedback channels
    has_sms_channel=True,           # essential for Africa even at entry tier
...
PLANS = [
    {
        ...
        "monthly_price_usd": Decimal("15.00"),
        "annual_price_usd":  Decimal("12.00"),
        "trial_days": 14,
        "sort_order": 1,
        "max_team_members": 5,
        "max_projects": 3,
